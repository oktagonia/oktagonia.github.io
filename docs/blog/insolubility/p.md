...
Look, I'm not going to go through all the basics of group-theory here, all you 
...
$G$ is soluble if there exists an $r \in \N$ such that $K_r(G)$ is the trivial
group.
...
of $H \subseteq G$ implies the insolubility of $G$—gives us the
